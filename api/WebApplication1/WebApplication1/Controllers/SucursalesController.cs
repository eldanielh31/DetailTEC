...
namespace WebApplication1.Controllers
{
    ...
    public class SucursalesController : ControllerBase
    {
        ...
        /**
         * Get(): Aplica el SELECT para obtener la información de las sucursales que se 
        ...
        /**
         * Post(): Aplica el INSERT para agregar una nueva sucursal a la base de datos.
         */
        ...
        /**
         * Put(): Aplica el UPDATE para actualizar información de las sucursales a la base de datos.
         */
        ...
        /**
         * Delete(): Aplica el DELETE para eliminar sucursales de la base de datos, se debe ingresar
         * el id de la sucusal.
         */
        ...
        /**
         * GetId(): Aplica el SELECT para obtener la información de las sucursales que se 
         * encuentran en la base de datos insertando el id de la sucursal.
         */
